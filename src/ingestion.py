...
class VectorDBIngestor:
    ...
    def process_reports(self, all_reports_dir: Path, output_dir: Path, skip_existing: bool = False):
        ...
        print(f"Vector DB build done. processed={processed}, skipped_existing={skipped}, total={len(all_report_paths)}")
